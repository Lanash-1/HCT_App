...
@Composable
private fun DailyReminderTimeDialog(initial: String?, onDismiss: () -> Unit, onConfirm: (String) -> Unit) {
  val (initialHour, initialMinute) = remember(initial) { parseTime(initial) }
