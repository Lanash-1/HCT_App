 ...
 *
 * @param {{
 *   habits: Array<{habitId: string|number, name: string}>,
 *   checkIns: Array<{habitId: string|number, date: string, done: boolean}>,
 *   weekDates: string[],
 ...
 *   perfectDays: number,
 *   perHabitSummary: Array<{habitId: string|number, name: string, score: number, dailyCells: boolean[]}>,
 * }}
 */
